...
fig1.circle(virginica_petal_length, virginica_petal_width, color=palette[2], legend='verginica')

# sepal length v. petal length
fig3 = figure(x_axis_label='Sepal length (cm)', y_axis_label='Petal width (cm)')
fig3.circle(setosa_sepal_length, setosa_petal_width, color=palette[0], legend='setosa')
fig3.circle(versicolor_sepal_length, versicolor_petal_width, color=palette[1], legend='versicolor')
fig3.circle(virginica_sepal_length, virginica_petal_width, color=palette[2], legend='verginica')

# sepal width v. petal width
fig2 = figure(x_axis_label='Sepal width (cm)', y_axis_label='Petal width (cm)')
fig2.circle(setosa_sepal_width, setosa_petal_width, color=palette[0], legend='setosa')
fig2.circle(versicolor_sepal_width, versicolor_petal_width, color=palette[1], legend='versicolor')
fig1.circle(virginica_sepal_width, virginica_petal_width, color=palette[2], legend='verginica')
